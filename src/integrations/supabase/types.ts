  ...
  public: {
    Tables: {
      ...
      checklist_question_answers: {
        ...
        Relationships: [
          {
            foreignKeyName: "checklist_question_answers_estimate_id_fkey"
            columns: ["estimate_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "checklist_question_answers_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
      ...
      labor_pay_run_items: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["time_log_id"]
            isOneToOne: true
            referencedRelation: "unpaid_time_logs_available_for_pay_run"
            referencedColumns: ["id"]
          },
          {
      ...
      project_checklist_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_checklist_items_project_checklist_id_fkey"
            columns: ["project_checklist_id"]
            isOneToOne: false
      ...
      project_checklists: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_checklists_estimate_id_fkey"
            columns: ["estimate_id"]
            isOneToOne: false
            referencedRelation: "estimates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_checklists_scope_block_id_fkey"
    ...
    Views: {
      ...
      unpaid_time_logs_available_for_pay_run: {
        Row: {
          company_id: string | null
          cost_code_id: string | null
          created_at: string | null
