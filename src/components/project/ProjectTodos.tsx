...
export const ProjectTodos = ({ projectId }: { projectId: string }) => {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle>Project To-Dos</CardTitle>
      ...
      <CardContent>
        <div className="space-y-3">
          {todos.length === 0 ? (
            <p className="text-center text-muted-foreground py-8">No todos yet. Create one to get started!</p>
          ) : (
            todos.map((todo) => (
