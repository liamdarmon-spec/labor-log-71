...
import { ProjectBudgetBuilderTab } from '@/components/project/ProjectBudgetBuilderTab';
...
export function ProjectBudgetTabV2({ projectId }: ProjectBudgetTabV2Props) {
  ...
  // NEW: toggle between Overview (existing view) and Builder
  ...
  return (
    <div className="space-y-6">
      {/* Mode toggle: Overview vs Builder */}
      ...
      {mode === 'overview' && (
        <>
          ...
          {/* Cost Code Ledger (unchanged, still uses inner Tabs) */}
          <Card>
            <CardHeader>
                        ...
                        {budgetData?.costCodeLines && budgetData.costCodeLines.length > 0 ? (
                          ...
                          <TableRow>
                            <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                              No budget lines found. Sync an estimate or use the Budget Builder to create a budget.
                            </TableCell>
                          </TableRow>
                        )}
                      </TableBody>
      ...
      {mode === 'builder' && (
        <ProjectBudgetBuilderTab projectId={projectId} />
      )}
    </div>
  );
}
