...
import { FileText, Download, Eye, Star, Zap } from 'lucide-react';
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Manage project estimates and sync to budget</CardDescription>
            </div>
              ...
              <TableBody>
                {estimates.map((estimate) => (
                  <TableRow key={estimate.id}>
                    ...
                    <TableCell>
                      <Badge className={getStatusBadge(estimate.status)} variant="outline">
                        {estimate.status}
                      </Badge>
                    </TableCell>
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <li>Map estimate lines to cost codes based on trade/category</li>
