...
export function DocumentHubTable({
  ...
  // AI analyze handler - TEMPORARILY DISABLED
    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          {/* AI Status column - TEMPORARILY HIDDEN */}
        ...
        {documents.map((doc) => {
          ...
          return (
            ...
            >
              ...
              {/* AI Status cell - TEMPORARILY HIDDEN */}
              
              <TableCell className="text-right" onClick={e => e.stopPropagation()}>
                <div className="flex items-center justify-end gap-1">
                  {/* Inline AI button - TEMPORARILY HIDDEN */}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      {/* AI Analysis menu item - TEMPORARILY HIDDEN
                      <DropdownMenuSeparator />
                      <DropdownMenuItem onClick={(e) => handleAnalyze(e as any, doc)}>
