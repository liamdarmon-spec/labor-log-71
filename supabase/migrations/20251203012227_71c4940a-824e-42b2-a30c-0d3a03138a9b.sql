...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.project_budgets DROP CONSTRAINT IF EXISTS project_budgets_project_id_fkey;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.project_budget_lines DROP CONSTRAINT IF EXISTS project_budget_lines_project_id_fkey;
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.project_budget_lines DROP CONSTRAINT IF EXISTS project_budget_lines_budget_id_fkey;
    ALTER TABLE public.project_budget_lines
