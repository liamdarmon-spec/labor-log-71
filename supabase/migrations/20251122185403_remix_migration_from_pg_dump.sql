...
-- Pre-clean: Remove duplicates from bid_invitations on (bid_package_id, sub_id)
...
-- Pre-clean: Remove duplicates from companies on (name)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from cost_codes on (code)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from day_cards on (worker_id, date)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from invitations on (email)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from project_budget_lines on (project_id, cost_code_id)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from project_budgets on (project_id)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from project_subcontracts on (project_id, sub_id)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from sub_bids on (bid_package_id, sub_id)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from trades on (name)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
...
-- Pre-clean: Remove duplicates from user_roles on (user_id, role)
-- Keep: smallest created_at (or smallest id if no created_at), delete rest
