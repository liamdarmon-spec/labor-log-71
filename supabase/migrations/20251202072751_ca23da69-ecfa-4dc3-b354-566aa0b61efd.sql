...
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_project_todos_project_id ON public.project_todos(project_id);

-- Add an index for filtering by status
CREATE INDEX IF NOT EXISTS IF NOT EXISTS idx_project_todos_status ON public.project_todos(status);